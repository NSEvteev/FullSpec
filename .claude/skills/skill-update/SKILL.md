...
> 1. [integration.md](/.claude/.instructions/.claude/skills/integration.md) — матрица применимости, критерии, форматы
...
> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#загрузка-скиллов)

### Шаг 3: Анализ применимости

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#критерии-применимости)

### Шаг 4: Сформировать предложения

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#формат-интеграции-в-воркфлоу)

### Шаг 5: Применить изменения

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#применение-интеграции)
...
> **SSOT:** [examples.md](/.claude/.instructions/.claude/skills/examples.md#skill-update)
