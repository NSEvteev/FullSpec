...
> 1. [integration.md](/.claude/.instructions/.claude/skills/integration.md) — типы ссылок, паттерны удаления
> 2. [errors.md](/.claude/.instructions/.claude/skills/errors.md) — обработка ошибок
>
...
> **SSOT:** [workflow.md](/.claude/.instructions/.claude/skills/workflow.md#получение-скилла)

### Шаг 2: Проверить факт удаления

> **SSOT:** [validation.md](/.claude/.instructions/.claude/skills/validation.md#проверка-существования)

### Шаг 3: Найти ссылки

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#типы-ссылок)

### Шаг 4: Сформировать предложения

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#формат-удаления)

### Шаг 5: Применить изменения

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#удаление-ссылок)

### Шаг 6: Обновить контекст

> **SSOT:** [workflow.md](/.claude/.instructions/.claude/skills/workflow.md#обновление-контекста)
...
> **SSOT:** [examples.md](/.claude/.instructions/.claude/skills/examples.md#skill-delete)
