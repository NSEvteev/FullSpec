...
> 1. [workflow-deactivate.md](/.instructions/workflow-deactivate.md) — **детальный воркфлоу DEACTIVATE (10 шагов)**
> 2. [statuses.md](/.instructions/statuses.md) — система статусов
> 3. [relations.md](/.instructions/relations.md) — обновление обратных ссылок в related
>
> **НЕ ПРОДОЛЖАТЬ** пока не прочитаны все файлы.

### Шаг 1: Получить путь

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-1-получить-путь)

### Шаг 2: Проверить существование

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-2-проверить-существование)

### Шаг 3: Прочитать содержимое

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-3-прочитать-содержимое)

### Шаг 4: Добавить предупреждение

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-4-добавить-предупреждение)

### Шаг 5: Закомментировать содержимое

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-5-закомментировать-содержимое)

### Шаг 6: Сохранить файл

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-6-сохранить-файл)

### Шаг 7: Обновить README папки

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-7-обновить-readme-папки)

### Шаг 8: Сбросить статус в главном README

> **SSOT:** [workflow-deactivate.md](/.instructions/workflow-deactivate.md#шаг-8-сбросить-статус-в-главном-readme)
...
> **SSOT:** [examples.md](/.instructions/examples.md#instruction-deactivate)
