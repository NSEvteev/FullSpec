...
> 1. [rules.md](/.claude/instructions/docs/rules.md) — маппинг путей, формат пометки
> 2. [workflow.md#docs-delete](/.claude/instructions/docs/workflow.md#docs-delete) — детальный воркфлоу
...
> **SSOT:** [rules.md#формат-пометки-doc-delete](/.claude/instructions/docs/rules.md#формат-пометки-doc-delete)
...
> **SSOT:** [examples.md#удаление-документации](/.claude/instructions/docs/examples.md#удаление-документации)
