...
> 1. [rules.md](/.claude/.instructions/.claude/skills/rules.md) — правила именования
> 2. [integration.md](/.claude/.instructions/.claude/skills/integration.md) — типы ссылок
> 3. [errors.md](/.claude/.instructions/.claude/skills/errors.md) — обработка ошибок
>
...
> **SSOT:** [validation.md](/.claude/.instructions/.claude/skills/validation.md#проверка-имён)
...
> **SSOT:** [workflow.md](/.claude/.instructions/.claude/skills/workflow.md#подтверждение-пользователя)

### Шаг 4: Переименование папки

> **SSOT:** [workflow.md](/.claude/.instructions/.claude/skills/workflow.md#переименование-скилла)

### Шаг 5: Обновление ссылок

> **SSOT:** [integration.md](/.claude/.instructions/.claude/skills/integration.md#обновление-ссылок)
...
> **SSOT:** [examples.md](/.claude/.instructions/.claude/skills/examples.md#skill-migrate)
