...
> 1. [rules.md](/.claude/instructions/meta/skills/rules.md) — правила именования
> 2. [integration.md](/.claude/instructions/meta/skills/integration.md) — типы ссылок
...
> **SSOT:** [validation.md](/.claude/instructions/meta/skills/validation.md#проверка-имён)
...
> **SSOT:** [workflow.md](/.claude/instructions/meta/skills/workflow.md#подтверждение-пользователя)

### Шаг 4: Переименование папки

> **SSOT:** [workflow.md](/.claude/instructions/meta/skills/workflow.md#переименование-скилла)

### Шаг 5: Обновление ссылок

> **SSOT:** [integration.md](/.claude/instructions/meta/skills/integration.md#обновление-ссылок)
...
> **SSOT:** [examples.md](/.claude/instructions/meta/skills/examples.md#skill-migrate)
