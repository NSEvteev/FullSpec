...
> 1. [format.md](/.claude/instructions/meta/links/format.md) — форматы ссылок
> 2. [patterns.md](/.claude/instructions/meta/links/patterns.md) — паттерны поиска и исключения
> 3. [workflow.md](/.claude/instructions/meta/links/workflow.md#фаза-create) — фаза CREATE
>
> **НЕ ПРОДОЛЖАТЬ** пока не прочитаны все три файла.

### Шаг 1: Получить документ

> **SSOT:** [workflow.md](/.claude/instructions/meta/links/workflow.md#фаза-create)

### Шаг 2: Найти упоминания (согласно patterns.md)

> **SSOT:** [patterns.md](/.claude/instructions/meta/links/patterns.md#поиск-упоминаний)

### Шаг 3: Проверить существование файлов

> **SSOT:** [patterns.md](/.claude/instructions/meta/links/patterns.md#исключения)
...
> **SSOT:** [examples.md](/.claude/instructions/meta/links/examples.md#links-create)
