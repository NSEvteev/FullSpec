...
| Аспект | Инструкция |
|--------|------------|
| Формат заголовка, префиксы | [issues/format.md](/.claude/instructions/issues/format.md) |
| Система меток | [issues/labels.md](/.claude/instructions/issues/labels.md) |
| Детальный workflow | [issues/workflow.md#issue-create](/.claude/instructions/issues/workflow.md#issue-create) |
...
> **Детали:** [issues/workflow.md#issue-create](/.claude/instructions/issues/workflow.md#issue-create)
