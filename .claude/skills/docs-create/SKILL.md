...
> 2. [workflow.md#docs-create](/.claude/instructions/docs/workflow.md#docs-create) — детальный воркфлоу
> 3. [templates.md](/.claude/instructions/docs/templates.md) — выбор шаблона
>
> **НЕ ПРОДОЛЖАТЬ** пока не прочитаны все файлы.

### Шаг 1: Валидация пути

> **SSOT:** [rules.md#валидация-путей](/.claude/instructions/docs/rules.md#валидация-путей)

### Шаг 2: Определение типа файла

> **SSOT:** [rules.md#поддерживаемые-языки](/.claude/instructions/docs/rules.md#поддерживаемые-языки)

### Шаг 3: Выбор шаблона

> **SSOT:** [templates.md#выбор-шаблона](/.claude/instructions/docs/templates.md#выбор-шаблона)

### Шаг 4: Анализ исходного файла

> **SSOT:** [workflow.md#шаги-подробно](/.claude/instructions/docs/workflow.md#шаги-подробно)

### Шаг 5: Генерация документации

> **SSOT:** [rules.md#шаблон-документации](/.claude/instructions/docs/rules.md#шаблон-документации)

### Шаг 6: Создание директорий и файла

> **SSOT:** [workflow.md#docs-create](/.claude/instructions/docs/workflow.md#docs-create)

### Шаг 7: Добавление ссылки в исходный файл

> **SSOT:** [structure.md#ссылки-в-коде](/.claude/instructions/docs/structure.md#ссылки-в-коде)
...
> **SSOT:** [examples.md#создание-документации](/.claude/instructions/docs/examples.md#создание-документации)
