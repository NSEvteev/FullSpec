...
> 1. [specs/statuses.md](/.claude/instructions/specs/statuses.md) — статусы, допустимые переходы
> 2. [specs/workflow.md](/.claude/instructions/specs/workflow.md) — каскадные переходы
> 3. [specs/naming.md](/.claude/instructions/specs/naming.md) — сокращённые пути
...
> **SSOT:** [specs/statuses.md](/.claude/instructions/specs/statuses.md#специфика-по-типам)

### Шаг 3: Проверить допустимость перехода

> **SSOT:** [specs/statuses.md](/.claude/instructions/specs/statuses.md#схема-переходов)

### Шаг 4: Проверить чек-лист перехода

> **SSOT:** Чек-листы в инструкциях по типам:
> - [discussions.md](/.claude/instructions/specs/discussions.md#чек-листы-переходов)
> - [impact.md](/.claude/instructions/specs/impact.md#чек-листы-переходов)
> - [adr.md](/.claude/instructions/specs/adr.md#чек-листы-переходов)
> - [plans.md](/.claude/instructions/specs/plans.md#чек-листы-переходов)

### Шаг 5: Обновить статус в документе

> **SSOT:** [specs/statuses.md](/.claude/instructions/specs/statuses.md#отображение-в-readme)
...
> **SSOT:** [specs/output.md](/.claude/instructions/specs/output.md#spec-status)
...
> **SSOT:** [specs/examples.md](/.claude/instructions/specs/examples.md#spec-status)
