...
| Детальный workflow | [issues/workflow.md#issue-complete](/.claude/instructions/issues/workflow.md#issue-complete) |
| Команды gh CLI | [issues/commands.md](/.claude/instructions/issues/commands.md) |
| CI pipeline | [git/ci.md](/.claude/instructions/git/ci.md) |
...
> **Детали:** [issues/workflow.md#issue-complete](/.claude/instructions/issues/workflow.md#issue-complete)
