...
- `/skill-update` → пометить `_old`, объединить в `/skill-modify`
- `/skill-delete` → пометить `_old`, объединить в `/skill-modify`
- `/skill-migrate` → пометить `_old`, объединить в `/skill-modify`
...
3. **Миграция старых скиллов** — ✅ Пометить `_old` (skill-update_old, skill-delete_old, skill-migrate_old)
...
- [ ] Пометить устаревшие папки `_old`: skill-update_old, skill-delete_old, skill-migrate_old
