...
**Задача:** Вынести содержание из [2026-02-08-specs-architecture.md](./2026-02-08-specs-architecture.md) в рабочие документы проекта — инструкции (`standard-*.md`), папки, rules.
...
**Связанные файлы:**
- [2026-02-08-specs-architecture.md](./2026-02-08-specs-architecture.md) — архитектура specs/ (источник)
...
Из [архитектуры specs/, раздел 9](./2026-02-08-specs-architecture.md).
...
**Источник контента:** [2026-02-08-specs-architecture.md](./2026-02-08-specs-architecture.md) — разделы указаны в описании каждого документа.

---

**Волна 1 — Справочник SDD (без зависимостей):**

| # | Документ | Источник из архитектуры |
|---|----------|------------------------|
| 1 | `specs/.instructions/standard-specs-reference.md` | §1 Философия, §2 Объекты (таблица, иерархия 6 уровней, расширяемость), §3 Статусы и каскады (все 7, прямой поток, каскады RUNNING/DONE/REJECTED/ROLLING_BACK/CONFLICT, обратная связь Code→Specs, кросс-цепочечная обратная связь), §5 Зоны ответственности (карта, границы), §6 Clarify и блокирующие правила (маркеры, Dependency Barrier, --auto-clarify) |

**Контент справочника:** Общие сущности SDD — статусы, каскады, порядок уровней, правила переходов, именование, связи parent→children, frontmatter, Clarify-паттерн, Dependency Barrier, зоны ответственности, запреты (миграция, архивирование), формат README-таблиц. **Не содержит:** воркфлоу-навигацию (это в оркестраторе, волна 8) и детали конкретных объектов (шаблоны, чек-листы — это в стандартах объектов).
...
**Волна 8 — Оркестратор-навигатор (последний, как standard-github-workflow.md):**

| # | Документ | Источник из архитектуры | Зависит от |
|---|----------|------------------------|------------|
| 11 | `specs/.instructions/standard-specs-workflow.md` | §4 Полный воркфлоу (диаграмма, общий паттерн объекта), §4 Shared код, §4 Upward feedback, §4 Параллельные дискуссии (Planned Changes) | ВСЕ предыдущие стандарты |

**Контент оркестратора:** HIGH-LEVEL навигатор по стадиям SDD. Каждая стадия — ссылка на SSOT стандарт объекта (паттерн `standard-github-workflow.md`). Полная диаграмма воркфлоу, порядок уровней, Shared код, Upward feedback, Planned Changes. **Не содержит:** определения статусов/каскадов (в справочнике) и детали объектов (в стандартах).
...
| 8 | Оркестратор первым или последним? | **Разделить на два:** справочник `standard-specs-reference.md` (shared-механика: статусы, каскады, frontmatter) — первым (волна 1). Оркестратор-навигатор `standard-specs-workflow.md` (карта стадий со ссылками на SSOT) — последним (волна 8). По аналогии с GitHub: `standard-github-workflow.md` создавался последним |
...
- [ ] Волна 5: Plan (0/1)
- [ ] Волна 6: Живые документы (0/2)
- [ ] Волна 7: Глоссарий (0/1)
- [ ] Волна 8: Оркестратор-навигатор (0/1)
