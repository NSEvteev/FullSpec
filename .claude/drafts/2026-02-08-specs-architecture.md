...
**Очистка REJECTED:** Раз в неделю (понедельник) LLM предлагает пользователю список REJECTED-документов (включая REJECTED-ADR) для удаления. REJECTED-документы — отклонённые решения, не часть истории. Пользователь решает, какие удалить, какие оставить.
