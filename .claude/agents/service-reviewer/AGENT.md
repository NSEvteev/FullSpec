...
Все факты из Design SVC-{N} присутствуют в {svc}.md.
Придуманных фактов не обнаружено.
Формат соответствует standard-service.md.
Chain-маркер в § 9 корректен.
```
...
| 3 | DISTORTED | § 4 Потоки | "Redis pub/sub" | "Kafka events" | Исправить на "Redis pub/sub" из Design |
```
