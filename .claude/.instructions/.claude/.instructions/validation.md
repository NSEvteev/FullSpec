...
Каждая инструкция ДОЛЖНА содержать навигационные ссылки после заголовка:
...
**Назначение:**
- **Индекс** — ссылка на главный README всех инструкций
- **Папка** — ссылка на README текущей папки
