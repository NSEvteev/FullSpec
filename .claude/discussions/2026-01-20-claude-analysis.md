...
| Q6 | Когда использовать context-update vs links-update? | Оба скилла, добавить сравнение | 🟡 |
...
| 2.1.2 | Добавить раздел сравнения | `/.claude/skills/context-update/SKILL.md` | ⬜ |
...
| # | Задача | Файл | Статус |
|---|--------|------|:------:|
| 2.3.1 | Добавить связи | `/.claude/skills/prompt-update/SKILL.md` | ⬜ |
...
| 2. Связи | 7 | 0 | ⬜ Не начато |
| 3. SSOT | 9 | 0 | ⬜ Не начато |
| 4. Workflow | 12 | 0 | ⬜ Не начато |
| 5. Nice to have | 6 | 0 | ⬜ Не начато |
| **Всего** | **53** | **0** | **0%** |
