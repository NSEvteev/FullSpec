...
Скиллы для автоматизации работы с деплоем:

| Скилл | Назначение |
|-------|------------|
| [/environment-check](/.claude/skills/environment-check/SKILL.md) | Проверка окружения перед деплоем |
| [/health-check](/.claude/skills/health-check/SKILL.md) | Проверка целостности проекта |
| [/test-execute](/.claude/skills/test-execute/SKILL.md) | Запуск тестов перед деплоем |
