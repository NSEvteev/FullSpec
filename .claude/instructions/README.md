...
Инструкции организованы по **5 разделам**:
...
| [instructions.md](./structure/instructions.md) | Структура инструкций (5 разделов) |
...
- [new_structure_of_project.md](/.claude/drafts/new_structure_of_project.md) — описание 5-scope структуры
