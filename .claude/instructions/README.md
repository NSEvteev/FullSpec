...
| [meta/](#meta--правила-и-claude) | `/.claude/` | Правила (git, links...) + Claude-сущности |

**Маппинг:** Папка `/X/` → инструкции `X/`. Правила → `meta/`.
...
| Инструкция | Описание |
|------------|----------|
| [project.md](./structure/project.md) | Структура папок проекта, зоны ответственности |
| [instructions.md](./structure/instructions.md) | Зеркальная структура инструкций |
| [mapping.md](./structure/mapping.md) | Маппинг: инструкции ↔ папки проекта |
...
## meta/ — Правила и Claude-сущности
...
| Инструкция | Описание |
|------------|----------|
| [commits.md](./meta/git/commits.md) | Conventional commits |
| [workflow.md](./meta/git/workflow.md) | GitHub Flow, ветки, PR |
| [review.md](./meta/git/review.md) | Code review, CODEOWNERS |
| [issues.md](./meta/git/issues.md) | Связь с GitHub Issues |

### meta/docs/ — Правила документации

| Инструкция | Описание |
|------------|----------|
| [structure.md](./meta/docs/structure.md) | Структура документации |
| [templates.md](./meta/docs/templates.md) | Шаблоны документов |
| [workflow.md](./meta/docs/workflow.md) | Процесс документирования |
| [rules.md](./meta/docs/rules.md) | Правила оформления |
| [errors.md](./meta/docs/errors.md) | Обработка ошибок |
| [examples.md](./meta/docs/examples.md) | Примеры |
...
### meta/agents/, meta/scripts/, meta/state/, meta/templates/, meta/drafts/
