...
**SSOT триггеров:** [standard-specs.md § 7.1](../standard-specs.md#71-обновление-при-планировании-to-waiting) — per-tech стандарты в общей таблице обновления при Design → WAITING.
