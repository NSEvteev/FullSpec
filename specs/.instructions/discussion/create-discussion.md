...
**SSOT:** [standard-discussion.md § 6](./standard-discussion.md#6-clarify), [Стандарт SDD § 8](../standard-specs.md#8-clarify-и-блокирующие-правила)
...
AskUserQuestion: "Перейти к созданию Impact Analysis?"

| Ответ | Действие |
|-------|----------|
| Да | Вызвать `/impact-create` с путём к текущей Discussion |
...
- [ ] Отчёт выведен
- [ ] Авто-предложение следующего этапа (Impact Analysis)
