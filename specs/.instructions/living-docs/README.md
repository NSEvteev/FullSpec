...
Инструкции для живых документов — файлов без статусов, отражающих текущее состояние системы. Обновляются автоматически при завершении спецификаций (ADR→DONE, Test Spec→DONE).
