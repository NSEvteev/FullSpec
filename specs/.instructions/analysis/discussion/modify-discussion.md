...
После того как пользователь принял/отклонил **ВСЕ** PROP в секции — LLM удаляет все записи PROP (независимо от решения) и заменяет секцию заглушкой: _Все предложения проработаны._
