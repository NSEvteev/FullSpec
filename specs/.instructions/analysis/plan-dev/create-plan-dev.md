...
4. **Маппинг GitHub Issues** — описание процесса и таблица маппинга (скопировать из шаблона)
...
12. "Все спецификации готовы. Начать через /dev 0001?" → Да → /dev 0001
```
...
11. WAITING → Отчёт
12. Предложен /dev → пользователь решает
```
