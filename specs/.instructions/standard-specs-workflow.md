...
7. **Когда ВСЕ документы цепочки в WAITING:**
   - ВСЕ документы в цепочке переходят в RUNNING ([§ 3.2 Справочника](./standard-specs-reference.md#32-waiting--running))
...
Upward feedback происходит **во время проектирования** — это нормальная часть workflow. Обратный каскад Code → Specs ([§ 3.3 Справочника](./standard-specs-reference.md#33-running--conflict)) запускается **после начала разработки**.
...
Архитектурные решения, относящиеся к навигации, уровням, воркфлоу и связям SDD. Решения по механикам (статусы, каскады, Clarify) — в [Справочнике SDD](./standard-specs-reference.md#8-решения).
