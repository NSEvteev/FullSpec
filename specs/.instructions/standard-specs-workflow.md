...
- [5. Связи между уровнями](#5-связи-между-уровнями)
  ...
  - [Фильтрация ADR → Тест-спек](#фильтрация-adr--тест-спек)
...
| 5. Тест-спек | `standard-test-spec.md` *(будет создан)* | [plan-test/](./plan-test/) |
| 6. План | [standard-plan.md](./plan-dev/standard-plan.md) | [plan-dev/](./plan-dev/) |
...
| 29 | Уровень Test Spec (ATDD) | **Уровень 5** между ADR и Plan. Тесты определяются ДО плана реализации |
...
| 48 | Task management в Plan | **Структурированные блоки** с полями: сложность, приоритет, зависимости, тест-спек, дельта *(→ standard-plan.md)* |
