...
Единая таблица ВСЕХ документов для изучения перед началом работы. Формат: таблица с 4 колонками (#, Документ, Путь, Что искать). Включает: .system/ файлы, Design секции, per-tech стандарты, сервисная документация, Plan Test. Issue содержит ПУТИ и описания — исполнитель сам читает файлы. Документы — SSOT, Issue — маршрут.
...
Информация, которой нет в спецификациях: существующий код (snapshot структуры), экспорты зависимостей (файл + функция + сигнатура), команды запуска/проверки. Для ручного Issue — как воспроизвести, окружение.
...
|---|----------|------|-----------|
| 1 | Архитектура системы | specs/docs/.system/overview.md | Карта сервисов, сквозной поток логина |
| 2 | Конвенции API | specs/docs/.system/conventions.md | Формат ответов/ошибок, JWT claims |
| 3 | Design SVC-3 § 4 | specs/analysis/0001-task-dashboard/design.md | Контракт POST /api/v1/auth/login |
| 4 | Design SVC-3 § 5 | (тот же файл) | Zustand 5.x, React Router 7, JWT в localStorage |
| 5 | Design INT-2 | (тот же файл) | Flow frontend ↔ auth |
| 6 | Сервисная документация | specs/docs/frontend.md | Code Map, структура, точки входа |
| 7 | React стандарт | specs/docs/.technologies/standard-react.md | ОБЯЗАТЕЛЬНО следуй при написании кода |
| 8 | TypeScript стандарт | specs/docs/.technologies/standard-typescript.md | ОБЯЗАТЕЛЬНО следуй при написании кода |
| 9 | Тестирование | specs/docs/.system/testing.md | Стратегия тестов, мокирование |
| 10 | Plan Test | specs/analysis/0001-task-dashboard/plan-test.md | TC-28, TC-29, TC-30 — напиши тесты по ним |
...
| # | Документ | Путь | Что искать |
|---|----------|------|-----------|
| 1 | Конвенции API | specs/docs/.system/conventions.md | Формат ошибок, лимиты payload |
| 2 | Сервисная документация | specs/docs/api-gateway.md | Code Map, обработка загрузок |
