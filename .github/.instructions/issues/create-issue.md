...
- [ ] Секция "Документы для изучения" — единая таблица документов
- [ ] Секция "Задание" — пошаговые инструкции с ссылками
- [ ] Секция "Критерии готовности" — чек-лист / ссылка на Plan Test
- [ ] Секция "Практический контекст" — код, экспорты, запуск
...
| # | Документ | Путь | Что искать |
|---|----------|------|-----------|
| 1 | Конвенции API | specs/docs/.system/conventions.md | Формат ошибок, лимиты |
...
| # | Документ | Путь | Что искать |
|---|----------|------|-----------|
| 1 | Инфраструктура | specs/docs/.system/infrastructure.md | CI/CD, деплой |
