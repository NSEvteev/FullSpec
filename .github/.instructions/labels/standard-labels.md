...
- [4. Связь type:\* с Issue Templates](#4-связь-type-с-issue-templates)
...
## 4. Связь type:* с Issue Templates

**SSOT шаблонов:** [standard-issue-template.md](../issue-templates/standard-issue-template.md)

Категория `type:*` имеет особую роль — каждая метка типа **ДОЛЖНА** иметь соответствующий Issue Template в `.github/ISSUE_TEMPLATE/`.
...
**При добавлении метки `type:*`:** создать Issue Template.

**При удалении метки `type:*`:** удалить Issue Template.
...
> **Для LLM:** При модификации меток `type:*` — проверить соответствие с Issue Templates.
