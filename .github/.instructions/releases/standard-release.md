...
**SSOT:** [standard-release-workflow.md § 3–4](./standard-release-workflow.md#3-подготовка-релиза)

Release ДОЛЖЕН быть связан с закрытым Milestone. Процесс проверки, закрытия Milestone и шаблон Release Notes с обязательной ссылкой на Milestone — см. SSOT.
