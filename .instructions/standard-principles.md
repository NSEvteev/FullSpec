---
description: Принципы программирования для скриптов автоматизации
...
Принципы и правила написания кода в скриптах автоматизации.
...
**Применимые принципы для скриптов:**
