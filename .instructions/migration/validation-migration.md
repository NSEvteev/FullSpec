...
2. Содержать шаги, соответствующие новой версии
...
**Дополнительно:** LLM проверяет содержание:
- Шаги обновлены под новую версию стандарта
- Чек-листы актуальны
...
```bash
# Найти скрипты, связанные со стандартом
grep -r "standard-{object}.md" .instructions/.scripts/

# Найти скиллы, связанные со стандартом
grep -r "standard-{object}.md" .claude/skills/
```
...
- [ ] `validation-{object}.md`: содержание соответствует стандарту
- [ ] `create-{object}.md`: standard-version актуален
- [ ] `create-{object}.md`: содержание соответствует стандарту
- [ ] `modify-{object}.md`: standard-version актуален (если есть)
- [ ] `modify-{object}.md`: содержание соответствует стандарту (если есть)
