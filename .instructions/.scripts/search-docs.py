...
Ищет по инструкциям, скиллам, агентам, правилам, README и скриптам.
...
VALID_TYPES = ["instruction", "skill", "agent", "rule", "readme", "script", "all"]
...
def main():
    ...
    parser.add_argument(
        ...
        default="all",
        choices=VALID_TYPES,
        help="Тип документа: instruction, skill, agent, rule, readme, script, all"
    )
