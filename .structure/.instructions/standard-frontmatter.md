---
description: Стандарт оформления frontmatter для всех .md файлов проекта — обязательные поля, description по типам документов, поля скиллов, агентов и спецификаций. Покрывает валидацию, версионирование и интеграцию с Claude Code.
...
- [5. Примеры](#5-примеры)
- [6. Обработка конфликтов версий](#6-обработка-конфликтов-версий)
- [7. Валидация frontmatter](#7-валидация-frontmatter)
- [8. Типичные ошибки](#8-типичные-ошибки)
- [9. Особые случаи](#9-особые-случаи)
- [10. Интеграция с Claude Code](#10-интеграция-с-claude-code)
