---
description: Стандарт оформления frontmatter для всех .md файлов проекта — обязательные поля, description по типам документов, поля скиллов и агентов. Покрывает валидацию, версионирование и интеграцию с Claude Code.
