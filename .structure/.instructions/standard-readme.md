...
При создании или изменении папок необходимо обновить связанные документы.

| Действие | Что обновить |
|----------|--------------|
| Создание папки | `/.structure/README.md` — добавить секцию, оглавление, дерево |
| Удаление папки | `/.structure/README.md` — удалить секцию, оглавление, дерево |
