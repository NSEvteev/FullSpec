...
- Скиллы: `/discussion`, `/discussion-review`, `/summary`, `/architect`, `/decision`, `/resource`, `/imp-plan`
...
- Вызван `/summary` — обновлён `000_SUMMARY.md`
...
2. **Скиллы вызывают друг друга** — `/discussion-review` автоматически вызывает `/summary` и `/architect`
